...
def backward(mnist):
    ...
    y=lenet5_forward.forward(x,1,lenet5_forward.regularizer)
    ...
    with tf.Session() as sess:
        ...
        for i in range(STEPS):
            ...
            summary_,result,loss_val,step,ce_val=sess.run([summary_merged,train_op,loss,global_step,ce],feed_dict={x:xs,y_:ys})
            if i%1000==0:
